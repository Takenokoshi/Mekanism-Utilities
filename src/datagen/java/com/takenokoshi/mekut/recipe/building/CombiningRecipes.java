...
public class CombiningRecipes {
    public static void build(RecipeOutput output) {
        ...
        CombinerRecipeBuilder.combining(
                creatorI.from(MekUtMaterial.COAL.rawTag(), 8),
        ...
        CombinerRecipeBuilder.combining(
                creatorI.from(MekUtMaterial.REDSTONE.rawTag(), 48),
                creatorI.from(Items.COBBLESTONE, 1),
        ...
        CombinerRecipeBuilder.combining(
                creatorI.from(MekUtMaterial.EMERALD.rawTag(), 8),
                creatorI.from(Items.COBBLESTONE, 1),
        ...
        CombinerRecipeBuilder.combining(
                creatorI.from(MekUtMaterial.LAPIS_LAZULI.rawTag(), 48),
                creatorI.from(Items.COBBLESTONE, 1),
        ...
        CombinerRecipeBuilder.combining(
                creatorI.from(MekUtMaterial.DIAMOND.rawTag(), 8),
                creatorI.from(Items.COBBLESTONE, 1),
        ...
        CombinerRecipeBuilder.combining(
                creatorI.from(MekUtMaterial.QUARTZ.rawTag(), 8),
        ...
        CombinerRecipeBuilder.combining(
                creatorI.from(MekUtMaterial.FLUORITE.rawTag(), 12),
                creatorI.from(Items.COBBLESTONE, 1),
