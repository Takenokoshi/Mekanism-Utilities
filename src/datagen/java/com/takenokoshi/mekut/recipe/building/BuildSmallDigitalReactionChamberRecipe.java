...
public class BuildSmallDigitalReactionChamberRecipe {
    public static void build(RecipeOutput output) {
        ...
        ItemStackListFluidChemicalToItemFluidChemicalRecipeBuilder
                .smallDigitalReactionChamber(new ItemStack(AFSingletons.REDSTONE_CRYSTAL, 64), FluidStack.EMPTY,
                        ChemicalStack.EMPTY)
                .addItemInput(MekUtItems.MU_MATERIALS_CRYSTAL.get(MUMaterial.REDSTONE), 144)
        ...
        ItemStackListFluidChemicalToItemFluidChemicalRecipeBuilder
                ...
                .addItemInput(MekUtItems.MU_MATERIALS_CRYSTAL.get(MUMaterial.LAPIS_LAZULI), 32)
                .setFluidInput(Tags.Fluids.WATER, 500)
