...
public abstract class SimpleInputRecipeCache<RECIPE extends Recipe<?>> implements IInputRecipeCache {
    protected final MekUtRecipeType<?, RECIPE, ?> recipeType;
    protected boolean initialized;

    protected SimpleInputRecipeCache(MekUtRecipeType<?, RECIPE, ?> recipeType) {
