...
public interface IMekStyledCrystalAssembler
        extends IItemStackListFluidRecipeLookupHandler<CrystalAssemblerRecipe>, IHasMachineEnergyContainer {
    ...
    @Override
    default @NotNull IMekUtRecipeTypeProvider<RecipeInput, CrystalAssemblerRecipe, ItemStackListFluidInputRecipeCache<CrystalAssemblerRecipe>> getRecipeType() {
        return WrappedRecipeType.EXTENDEDAE_CRYSTAL_ASSEMBLER;
    }
}
