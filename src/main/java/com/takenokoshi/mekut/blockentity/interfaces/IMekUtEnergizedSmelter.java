...
public interface IMekUtEnergizedSmelter
        extends IMekUtRecipeTypedLookupHandler<SmeltingRecipe, SingleIngredientRecipeCache<SmeltingRecipe>> {
    ...
    default IMekUtRecipeTypeProvider<?, SmeltingRecipe, SingleIngredientRecipeCache<SmeltingRecipe>> getRecipeType() {
