...
public class BEStandardMekStyledReactionChamber extends BEMultiScaledProgressMachine<ReactionChamberRecipe>
    ...
    public BEStandardMekStyledReactionChamber(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
        ...
        ejectorComponent = new TileComponentEjector(this, () -> 0, () -> 10000)
    ...
    protected @Nullable IFluidTankHolder getInitialFluidTanks(IContentsListener listener,
        ...
        builder.addTank(inputTank = BasicFluidTank.input(4000000,
                ...
                recipeCacheListener));
        builder.addTank(outputTank = BasicFluidTank.output(0x7fffffff, recipeCacheUnpauseListener));
        return builder.build();
    }
