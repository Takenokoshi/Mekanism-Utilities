...
public class BEStandardChemicalInjectionChamber extends BEBasicItemStackChemicalToItemStackMachine {
    ...
    @Override
    public @NotNull IMekUtRecipeTypeProvider<?, ItemStackChemicalToItemStackRecipe, ItemChemical<ItemStackChemicalToItemStackRecipe>> getRecipeType() {
        return WrappedMekanismRecipeType.INJECTING;
    }
