...
import com.takenokoshi.mekut.inventory.slot.LimitChangedOutputInventorySlot;
...
public class BEIceMaker extends BEMultiScaledProgressMachine<FluidToItemRecipe>
        implements IFluidToObjectMachine<FluidToItemRecipe>, IHasMachineEnergyContainer {
    ...
    protected @Nullable IInventorySlotHolder getInitialInventory(IContentsListener listener,
        ...
        builder.addSlot(inputSlot = FluidInventorySlot.fill(inputTank, listener, 8, 34))
    ...
    protected @Nullable IFluidTankHolder getInitialFluidTanks(IContentsListener listener,
        ...
        builder.addTank(inputTank = BasicFluidTank.input(20000, this::containsRecipe, recipeCacheListener));
        return builder.build();
    }
    ...
    @Override
    public @NotNull IMekUtRecipeTypeProvider<?, FluidToItemRecipe, MUSingleInputRecipeCache.MUSingleFluid<FluidToItemRecipe>> getRecipeType() {
