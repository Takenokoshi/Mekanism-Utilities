...
public class BEMekStyledCrystalAssembler extends BEMultiScaledProgressMachine<CrystalAssemblerRecipe>
    ...
    public BEMekStyledCrystalAssembler(Holder<Block> blockProvider, BlockPos pos, BlockState state) {
