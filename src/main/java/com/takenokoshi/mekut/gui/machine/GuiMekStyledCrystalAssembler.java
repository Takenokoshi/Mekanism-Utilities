...
public class GuiMekStyledCrystalAssembler<BE extends BlockEntityMekUtProgressMachine<CrystalAssemblerRecipe> & IMekStyledCrystalAssembler>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiMekStyledCrystalAssembler(MekanismTileContainer<BE> container, Inventory inv, Component title) {
