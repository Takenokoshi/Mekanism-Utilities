...
public class GuiMekStyledReactionChamber<BE extends BlockEntityMekUtProgressMachine<ReactionChamberRecipe> & IMekStyledReactionChamber>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiMekStyledReactionChamber(MekanismTileContainer<BE> container, Inventory inv, Component title) {
