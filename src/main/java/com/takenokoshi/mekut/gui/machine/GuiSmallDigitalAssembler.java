...
public class GuiSmallDigitalAssembler<BE extends TileEntityMekanism & ISideConfiguration & IItemStackListFluidChemicalToItemRecipeMachine & IHasMachineEnergyContainer & IHasGuiSizeOffset & IWarningSupporter & IRecipeViewerTypeProvider>
        extends GuiConfigurableTile<BE, MekALDynamicSizedContainer<BE>> {

    public GuiSmallDigitalAssembler(MekALDynamicSizedContainer<BE> container, Inventory inv, Component title) {
