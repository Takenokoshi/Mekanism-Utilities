...
public class GuiBasicItemStackToItemStackMachine<BE extends BEBasicItemStackToItemStackMachine>
        extends GuiConfigurableTile<BE, MekanismTileContainer<BE>> {

    public GuiBasicItemStackToItemStackMachine(MekanismTileContainer<BE> container, Inventory inv, Component title) {
