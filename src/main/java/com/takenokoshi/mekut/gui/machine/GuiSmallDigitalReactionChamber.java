...
public class GuiSmallDigitalReactionChamber<BE extends BlockEntityMekUtRecipeMachine<ItemStackListFluidChemicalToItemFluidChemicalRecipe> & IItemStackListFluidChemicalToItemFluidChemicalRecipeMachine & IHasMachineEnergyContainer & IHasGuiSizeOffset>
    ...
    protected void addGuiElements() {
        ...
        addRenderableWidget(new GuiChemicalGauge(tile::getInputChemicalTank, () -> tile.getChemicalTanks(null),
                GaugeType.SMALL, this, 28, 27)).warning(WarningType.NO_MATCHING_RECIPE,
                        tile.getWarningCheck(RecipeError.NOT_ENOUGH_INPUT));
        addRenderableWidget(new GuiChemicalGauge(tile::getOutputChemicalTank, () -> tile.getChemicalTanks(null),
                GaugeType.SMALL, this, 176, 27)).warning(WarningType.NO_SPACE_IN_OUTPUT,
                        tile.getWarningCheck(RecipeError.NOT_ENOUGH_OUTPUT_SPACE));
        addRenderableWidget(new GuiFluidGauge(tile::getOutputFluidTank, () -> tile.getFluidTanks(null),
                GaugeType.SMALL, this, 199, 27)).warning(WarningType.NO_SPACE_IN_OUTPUT,
                        tile.getWarningCheck(RecipeError.NOT_ENOUGH_OUTPUT_SPACE));
        addRenderableWidget(new GuiVerticalPowerBar(this, tile.getEnergyContainer(), 222, 21))
        ...
        addRenderableWidget(new GuiDownArrow(this, 204, 77));
    }
